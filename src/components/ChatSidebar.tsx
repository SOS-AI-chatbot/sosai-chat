...
const ChatSidebar = () => {
  ...
  return (
    <div className="w-80 bg-white/30 backdrop-blur-sm border-r border-white/20 h-full flex flex-col">
      {/* Header */}
      <div className="p-6 border-b border-white/20">
        ...
        <div className="flex gap-2">
          <Button 
            size="icon" 
            variant="ghost" 
            className="rounded-full bg-gradient-to-r from-pastel-purple to-pastel-pink hover:scale-105 transition-all duration-200"
          >
          ...
          <Button 
            size="icon" 
            variant="ghost" 
            className="rounded-full bg-gradient-to-r from-pastel-orange to-pastel-yellow hover:scale-105 transition-all duration-200"
          >
          ...
          <Button 
            size="icon" 
            variant="ghost" 
            className="rounded-full bg-gradient-to-r from-pastel-blue to-pastel-green hover:scale-105 transition-all duration-200"
          >
          ...
          >
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0">
                <MessageCircle className="h-5 w-5 text-gray-600 mt-1" />
              </div>
      ...
      <div className="p-4 border-t border-white/20">
        <div className="bg-gradient-to-r from-green-200/50 to-blue-200/50 rounded-2xl p-4">
